SELECT `id`,`followers`,`posts`, `following`, `country_id`, `website`, `avatar`,`about`,`last_active`,`is_online`,`username`,`fname`,`lname`,`email`,`verified`, `followers`, `follow_privacy` FROM `<?php echo($data['t_users']); ?>`
